...
public:
    ...
    long long price() const override { /* TODO: leaf price */ return 0; }
    long long units() const override { /* TODO: leaf unit count */ return 0; }
};
class DrinkFactory {
public:
    ItemPtr create(const std::string& kind) const {
        (void)kind;
        // TODO: create the requested leaf, or return nullptr for an unknown kind.
        return nullptr;
    }
};
...
public:
    ...
    long long price() const override { /* TODO: delegate and add */ return 0; }
    long long units() const override { /* TODO: preserve wrapped units */ return 0; }
};
...
public:
    ...
    long long price() const override {
        // TODO: recursively combine all child prices.
        return 0;
    }
    long long units() const override {
        // TODO: recursively combine all child unit counts.
        return 0;
    }
};
class OrderFacade {
